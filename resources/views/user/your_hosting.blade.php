                            ...
                            <div class="item">
                                <div class="parties-wrap">
                                    <div class="parties-head">
                                        ...
                                        <div class="event-mf">
                                            <i class="fa <?php if ($event->guest_gender == 'Men Only') {
                            echo 'fa-male';
                        } elseif ($event->guest_gender == 'Ladies only') {
                            echo 'fa-female';
                        } elseif ($event->guest_gender == 'Singles only') {
                            echo "fa-user";
                        } ?>" aria-hidden="true"></i>
                                    ...
                                    <div class="parties-host">
                                        <div class="hosted-by">
                                            ...
                                            <div class="content">
                                                ...
                                                <p>Aged: <strong>{{ date('Y') - explode('/', $event->dob)[2] }}</strong></p>
