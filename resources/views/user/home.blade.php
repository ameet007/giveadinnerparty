						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td style="width: 40%"><strong>Sheng Wong</strong></td>
									<td style="width: 35%;"><a href="#">Edit</a></td>
								</tr>
								<tr>
									<td>Birth Date:</td>
									<td><strong>21 December 2017</strong></td>
									<td><a href="#">Edit</a></td>
								</tr>
								<tr>
									<td>Gender:</td>
								...
								<tr>
									<td>Biography:</td>
									<td><strong>I,m a Cool Guy in a Cool World</strong></td>
									<td><a href="#">Edit</a></td>
								</tr>
								<tr>
									<td>Your Rating:</td>
				...
				<table class="table">
					<tbody>
						<tr>
							...
							<td style="width: 25%"><strong>sheng@causeeffect.asia</strong></td>
							<td style="width: 60%;">&nbsp;</td>
						</tr>
						<tr>
							<td>Tel No:</td>
							<td><strong>+6041545428664</strong></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>Address:</td>
							<td><strong>Madison Court Reception, Off Faraday Road, Nottingham NG7 2EG, United Kingdom</strong></td>
							<td>&nbsp;</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table">
					<tbody>
						<tr>
							...
							<td style="width: 25%"><strong>Nascar Racer</strong></td>
							<td style="width: 60%;">&nbsp;</td>
						</tr>
						<tr>
							<td>Education:</td>
						...
						<tr>
							<td>Religion:</td>
							<td><strong>Not Specific</strong></td>
							<td>&nbsp;</td>
						</tr>
					</tbody>
				</table>
