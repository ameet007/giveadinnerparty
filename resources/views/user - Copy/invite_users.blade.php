...
@endif
<div class="middle-content account-section invite-fri">
    <div class="container">
            ...
            <aside class="col-md-2 left-sidebar">
                <div class="sidenav-list">
                    <ul>
                        ...
                        <li class='active'><a href='{{Request::root()}}/user/invite_friends'>Invite Users</a></li>
                    </ul>
                </div>
            </aside>
            <div class="col-md-10">
				<div class="my-events">
				<div class="dinnerhost-party">
					<div class="dinner-hostright invite-your">
						<header><a href="invite-friends.html">Invite <img src="{{Request::root()}}/assets/front/img/logo.png" alt=""> Users</a></header>
					</div>
				</div>
				<p>How nice is it to receive an invitation to a party? Browse the profiles of other community members near you and invite a few along.</p>
				<div class="dis-tance">
					<div class="row">
						<div class="col-md-8">
							<div class="form-group">
								<label>Search Users</label>
								<input type="text" class="form-control" id="town_postcode" placeholder="Enter town or postcode" required />
								<span class="font12">Please note members can opt out of having searchable profiles in their <a href="#">privacy settings</a>. They can also opt out of host invitations in their <a href="#">notifications settings</a></span>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
...
$(document).ready(function(){
	...
	$('#find').click(function(){
                var postcode_town = $('#town_postcode').val();
                $.ajax({
                    url: '{{Request::root()}}/user/search_event',
                    type: 'post',
                    data: {'_token':'{{csrf_token()}}','postcode_town':postcode_town},
        ...
        $('#find2').click(function(){
                ...
                $.ajax({
                    url: '{{Request::root()}}/user/search_event',
                    type: 'post',
                    data: {'_token':'{{csrf_token()}}','postcode_town':postcode_town,'age1':age1,'age2':age2,'gender':gender,'status':status,'sexuality':sexuality,'education':education,'ethnicity':ethnicity,'religion':religion},
                    success: function(data){
                        $('#filter_response_data').html(data);
                    }
                })
        ...
        $('#find3').click(function(){
                ...
                $.ajax({
                    url: '{{Request::root()}}/user/search_event',
                    type: 'post',
                    data: {'_token':'{{csrf_token()}}','postcode_town':postcode_town,'age1':age1,'age2':age2,'gender':gender,'status':status,'sexuality':sexuality,'education':education,'ethnicity':ethnicity,'religion':religion,'hobbies':hobbies},
                    success: function(data){
                        $('#filter_response_data').html(data);
                    }
                })
        ...
        $('#find4').click(function(){
                ...
                $.ajax({
                    url: '{{Request::root()}}/user/search_event',
                    type: 'post',
                    data: {'_token':'{{csrf_token()}}','postcode_town':postcode_town,'age1':age1,'age2':age2,'gender':gender,'status':status,'sexuality':sexuality,'education':education,'ethnicity':ethnicity,'religion':religion,'languages':languages},
