                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                ...
                                <div class="account-content">
                                    ...
                                    @endif
                                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/charity/password/email') }}">
                                      {{ csrf_field() }}
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Already have account?<a href="{{Request::root()}}/charity/login" class="text-primary m-l-5"><b>Sign In</b></a></p>
                                </div>
                            </div>
