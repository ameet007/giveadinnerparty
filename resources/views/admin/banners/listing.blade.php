...
<div class="content-page">
  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12">
          <a class="btn btn-success" href="{{Request::root()}}/admin/banners/add">Add</a>
            ...
            <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-12"><table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
              <thead>
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 326px;">Image</th>                  
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
					...
					<td><img style="width:100px; height:100px;" src="{{Request::root()}}/assets/admin/uploads/banner/{{$item->image}}" /></td>
					<td><?= ($item->status == 0) ? 'Disabled' : 'Enabled' ?></td>
					<td class="actions">
						<a href="{{Request::root()}}/admin/banners/edit/{{$item->id}}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
						<a href="{{Request::root()}}/admin/banners/delete/{{$item->id}}" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
					</td>
                </tr>
                @endforeach
              </tbody>
