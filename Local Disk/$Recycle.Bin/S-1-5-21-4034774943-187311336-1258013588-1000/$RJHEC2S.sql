...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2017 at 06:52 AM
...
(1, 'Admin', 'admin@giveadinnerparty.com', '$2y$10$LWenYgaEONwxu1C16VnReO5kSngQAeI26zr.rr6eKZwEjDMGIFWiq', 'UcNkHWVhaTJq9bl9mobQufxEJPO0F8W60NANRfOn0r4HpSKeekNioQDj0Ybg', '2017-06-24 13:02:19', '2017-06-24 13:02:19');
...
(2, 1, 2, 1, '2017-07-27 05:32:40', '2017-07-28 23:33:41');
...
(1, 2, 'Give A Dinner Party', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '08/05/2017', '01:30:00', '04:15:00', 'street 007', 'delhi', 'india', '110009', 'India', 'Alcohol Ok', '5 Courses', 'Yes', 'any', 'Brunch', '["Vegetarian","Vegan","Kosher","Gluten Free"]', 'Singles Only', 'Singles only', 21, 27, 'Straight', 'Smart', 'Indoor', 'Sofa And/or Chairs', '4', '5', '2', '60', '9899009988', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 20, 1, NULL, '2017-07-31 05:13:06'),
(2, 2, 'Lorem Ipsum is simply dummy  13221', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.111', '07/04/2017', '01:30:00', '04:15:00', 'street 007', 'delhi', 'india', '110009', 'India', 'Alcohol Ok', '5 Courses', 'Yes', 'any', 'Brunch', '["Vegetarian","Vegan","Kosher","Gluten Free"]', 'Singles Only', 'Men Only', 21, 27, 'Straight', 'Smart', 'Indoor', 'Sofa And/or Chairs', '4', '5', '2', '50', '9899009988', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 40, 1, NULL, '2017-07-31 05:12:56');
...
CREATE TABLE `invitefriends` (
  ...
  `user_id` int(11) NOT NULL,
  `friend_email` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `invitefriends` (`id`, `transaction_id`, `user_id`, `friend_email`, `event_id`, `created_at`, `updated_at`) VALUES
(1, 1, 2, 'phpdeveloper70@gmail.com', '2', '2017-07-20 05:37:26', '2017-07-20 06:19:45'),
(2, NULL, 2, 'anaseem711@gmail.com', '2', '2017-07-29 02:37:31', NULL);
...
(1, 2, '1', '1', '', '2017-07-31 19:38:10', NULL);
...
(1, 2, '1', 'invited you to his', 1, 'invite', 1, NULL, '2017-08-01 07:34:09'),
(2, 1, '2', 'invited you to his', 1, 'invite', 1, '2017-07-31 19:38:10', '2017-08-01 07:48:04');
...
CREATE TABLE `tickets` (
  ...
  `charity_id` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `charity_cut` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tickets` (`id`, `event_id`, `user_id`, `ticket_price`, `charity_id`, `charity_cut`, `status`, `created_at`, `updated_at`) VALUES
(1, '1', '2', '26.25', '2', '12', '1', '2017-07-31 03:37:55', '2017-07-31 06:18:45');
...
(1, 'AP-0DW71702AE568720F', '1J6367561G217980X', 'phpdeveloper70@gmail.com', '2', '40', 'COMPLETED', NULL, '2017-07-20 06:18:16');
...
(1, 'Prashant Gupta', 'prashant2621993@live.com', '$2y$10$k0hV3jWQmyhiYgKHtJRjwexw3MadoOZ4BPP.RJryGt7zwrrl9.P/m', 'sefgfh', '07/13/2017', NULL, 'Male', NULL, NULL, NULL, 'H.No. 217, Okhla 1', 'Delhi', 'county', 'India', '110001', NULL, NULL, NULL, NULL, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '["Socialising & Friendship","Dating","Travel & Culture","Kids & Parenting","Charity & Fundraising","Religion & Spirituality","Meditation, Yoga & Healing","Board Games","Crafts & Hobbies"]', NULL, NULL, NULL, NULL, NULL, 'testmail0987654@gmail.com', 1, '0', NULL, 1, NULL, 0, 1, NULL, 0, 'Utd9ZVFxvFAWL2YfFnc9mpjz4uEvp19NPwnZVMOVAAFdpRsWZryE1SHRJCzM', '2017-06-30 16:23:13', '2017-07-27 06:32:15'),
(2, 'Naseem', 'anaseem711@gmail.com', '$2y$10$6rVxHMcq81qH2qWmmKDuo.UhGDW2SrdlgrWlkwFk8hqdctjADaTXC', 'ahmad', '07/05/1990', 'Single', 'Female', 'Chinese', 'Lesbian', '9899004510', 'H.No. 217, Okhla 1', 'Delhi 2 ok', 'county 3', 'India 4', '110009', '["Arabic","Bengali","Czech","Dutch","French","Mandarin","Punjabi","Romanian","Swedish","Thai"]', '', NULL, NULL, 'You can add multiple-column unique indexes via phpMyAdmin.', '["Socialising & Friendship","Dating","Travel & Culture","Charity & Fundraising","Religion & Spirituality","Video Games","Card Games","Art & Antiques"]', 'php developer', 'bca', 'testing', '$2y$10$WBEDCFhAfcF2o0tpBTYIhe7ZtMLS20KA08QiIG4Hski.Hsfm.vCkm', NULL, 'testmail0987654@gmail.com', 1, '1', '1499859467Tulips.jpg', 1, '1499859461Tulips.jpg', 0, 1, '35467874323456789', 0, 'h5u1WoGMJA3s7hyHliozrYDuUv8MZ2l2X2gnj0JI4OoRwTbuxCLsVezUd7dN', '2017-07-04 18:30:00', '2017-08-01 05:57:57'),
...
(5, 'Praveen', 'phpdeveloper70@gmail.com', '$2y$10$1kxSA.mr48dAbzdlAfDKtOSJnsVc5n9j1pBmCrDxAaiUAH76mgE3.', NULL, '3/5/1990', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 'sadfgfdggdfg fdgfdgfdgfd  fdgfdgfdgfd  fgdfdg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1', NULL, 0, NULL, 0, 1, '8031925476', 0, 'n5rwUTYlMaZvPEVNRbJWDEoCbT7EPUMU7puOwVjfvrK0TKv675bQBpKRfDs2', '2017-07-10 02:16:22', '2017-07-10 08:10:22'),
