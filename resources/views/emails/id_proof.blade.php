					...
					<tbody>
						...
						<tr>
							<td align="center" style="font:18px/22px Helvetica,Arial,Roboto,Noto,sans-serif;color:#484848">
								You are receiving this email because user request you for approve ID Proof
							</td>
						</tr>
						<tr>
							<td align="center" style="font:18px/22px Helvetica,Arial,Roboto,Noto,sans-serif;color:#484848">
								Please click the link below to approve ID Proof.
							</td>
						</tr>
						<tr>
									...
									<tbody>
										<tr>
											<td width="310" align="center" style="font:bold 21px/24px Helvetica,Arial,sans-serif;color:#fff;border-radius:5px;background-size:100% 100%;" bgcolor="#013cbb">
												<a style="text-decoration:none;color:#fff;display:block;padding:16px 15px" href="{{Request::root()}}/admin/verify_id/<?php echo Crypt::encrypt($user->id); ?>" target="_blank">
