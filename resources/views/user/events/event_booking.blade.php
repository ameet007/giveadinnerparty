            ...
            <div class="col-md-4 col-sm-12">
				<div class="dinner-hostright">
					...
					<div class="con-gratulation">
						...
						<?php } else{ ?>
							<a href="#" class="grey-btn btn-block" >Purchase Tickets</a>
							<button class="grey-btn btn-block" id="cancel_tickets" >Cancel Tickets</button>
						<?php } ?>
					</div>
					<footer>
						<div class="media">
...
<form method="post" id="request_ticket_form">
	...
	<input type="hidden" name="booking_fee" value="6.25">
	<input type="hidden" name="charity_id" value="{{ $event->charity_id }}">
	<input type="hidden" name="charity_cut" value="{{ $event->charity_cut }}">	
	<input type="hidden" name="final_amount" value="{{ $event->ticket_price+6.25 }}">
</form>
