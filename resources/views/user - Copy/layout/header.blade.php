		...
		<div class="row pro-header-top">
			...
			<div class="pro-header-right col-md-6 col-sm-12 col-sm-12 pull-right">
				<div class="tow-notification pull-right">
					...
					<?php $notification = DB::select( DB::raw("SELECT * FROM notifications WHERE user_id ='$user_id' and is_seen='0'") ); ?>
					<a href="{{ request::root() }}/user/notifications">
						<i class="fa fa-globe" aria-hidden="true"></i><sup><?php echo count($notification); ?></sup>
					</a>
					<span class="dropdown">
