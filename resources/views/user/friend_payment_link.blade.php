        ...
        <div class="row clearfix">
            ...
            <article class="col-md-10">
                <div class="dinner-parties">
					...
					<form method="post" action="{{Request::root()}}/user/friend_payment_link">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="row">
									<div class="col-xs-8">
										<div class="form-group">
											<select class="form-control" onchange="return showdiv(this.value);" name="event_id" required>
								...
								<div class="f-pay-m">
									...
									<input type="hidden" id="one_ticket_price" name="price" value="" required>
									<div class="row">
										<div class="col-xs-8">
											<div class="form-group">
										...
										<div class="col-xs-8">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="John" name="name" id="friend_name" required/>
											</div>
										</div>
										<div class="col-xs-8">
											<div class="form-group">
												<label>Enter Friend’s Email Address</label>
												<input type="text" class="form-control" placeholder="John@webdomain.com" name="email" id="friend_email" required/>
											</div>
										</div>
										<div class="col-xs-8">
											<div class="form-group">
												<label>Total Price For <span id="count_ticket">0</span> Tickets</label>
												<input type="text" class="form-control" name="total_price" id="total_ticket_price" placeholder="£0.00" required/>
											</div>
