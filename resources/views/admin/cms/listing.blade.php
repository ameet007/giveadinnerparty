...
<div class="content-page">
  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12">
			<a class="btn btn-success" href="{{Request::root()}}/admin/cms/add">Add</a>
            ...
            <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-12"><table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
					...
					<td class="actions">
						<a href="{{Request::root()}}/admin/cms/edit/{{$item->id}}" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
					</td>
                </tr>
                @endforeach
              </tbody>
