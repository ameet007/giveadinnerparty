...
<section class="middle-content host-step">
    <form method='post' id='create_event_form' action='{{Request::root()}}/user/edit_event/{{ $events_details->id }}' />
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name='title' class="form-control" value="{{ $events_details->title }}" placeholder="Title For Your Event" required />
                                </div>
                                @if(ISSET($errors))
                    ...
                    <div class="col-xs-12 feild">
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <h4>Description</h4>
                                <div class="form-group">
                                    <textarea name='description' class="form-control" required >{{ $events_details->description }}</textarea>
                                </div>
                                @if(ISSET($errors))
                                <ul class="parsley-errors-list filled" id="parsley-id-5">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <div class="input-group date" data-provide="datepicker">
                                    <input name='event_date' value="{{ $events_details->event_date }}" type="text" class="form-control" placeholder="Enter Your Event Date" required />
                    ...
                    <div class="col-xs-12 feild">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                ...
                                <div class="form-group">
                                    <input name='street' value="{{  $events_details->street }}" type="text" class="form-control" placeholder="Enter Your Street and Home Number" required />
                                </div>
                                @if(ISSET($errors))
                                <ul class="parsley-errors-list filled" id="parsley-id-5">
                    ...
                    <div class="col-xs-12 feild">
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        <input name='city' type="text" value="{{ $events_details->city }}" class="form-control" placeholder="Enter City" required />
                                    </div>
                                    @if(ISSET($errors))
									<ul class="parsley-errors-list filled" id="parsley-id-5">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        <input name='county' type="text" value="{{  $events_details->county }}" class="form-control" placeholder="Enter County" />
                                    </div>
                                    @if(ISSET($errors))
                                <ul class="parsley-errors-list filled" id="parsley-id-5">
                    ...
                    <div class="col-xs-12 feild">
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <div class="form-group">
                                        <input name='postal_code' type="text" value="{{  $events_details->postal_code }}" pattern="[0-9a-zA-Z]+" class="form-control" placeholder="Enter Your Postcode" required />
                                    </div>
                                    @if(ISSET($errors))
                                <ul class="parsley-errors-list filled" id="parsley-id-5">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name='drinks_included' value="{{  $events_details->drinks_included }}" type="text" class="form-control" placeholder="Included Drinks" />
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container host-step3">
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name='min_guests' value="{{ $events_details->min_guests }}" required type="number" class="form-control" placeholder="1" />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label>Guests (Max)</label>
                                    <input name='max_guests' value="{{ $events_details->max_guests }}" required type="number" class="form-control" placeholder="6" />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label>Price Per Ticket ($1 - $100)</label>
                                    <input name='ticket_price' id='ticket_price' value="{{ $events_details->ticket_price }}" required type="number" class="form-control" placeholder="20" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="refer-number">
                            ...
                            <input name='reference_number' type="text" class="form-control" placeholder="Reference Number" value="{{ $events_details->reference_number }}"/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xs-12 feild">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                ...
                                <div class="form-group">
                                    <textarea name='welcome_note' required class="form-control" placeholder="Say hi, and Tell Them How to Get To Your Place">{{ $events_details->welcome_note }}</textarea>
                                </div>
            ...
            <div class="tow-btn">
                <button type='submit' id='submit_event' class="btn2">Update Your Dinner Party</button>
            </div>
        </div>
        </form>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        var start_time = '<?php echo $events_details->start_time ?>';
		$("select[name='start_time_1']").val(start_time.substr(1,1));
		$("select[name='start_time_2']").val(start_time.substr(3,2));
		
		var end_time = '<?php echo $events_details->end_time ?>';
		$("select[name='end_time_1']").val(end_time.substr(1,1));
		$("select[name='end_time_2']").val(end_time.substr(3,2));
		
		$("select[name='country']").val('<?php echo $events_details->country; ?>');
		
		$("select[name='drink_preferences']").val("<?php echo $events_details->drink_preferences; ?>");
		$("select[name='own_drinks']").val("<?php echo $events_details->own_drinks; ?>");
		$("select[name='food_included']").val("<?php echo $events_details->food_included; ?>");
		$("select[name='food_type']").val("<?php echo $events_details->food_type; ?>");
		
		$("select[name='open_to']").val('<?php echo $events_details->open_to; ?>');
		$("select[name='guest_gender']").val('<?php echo $events_details->guest_gender; ?>');
		$("select[name='min_age']").val('<?php echo $events_details->min_age; ?>');
		$("select[name='max_age']").val('<?php echo $events_details->max_age; ?>');
		$("select[name='orientation']").val('<?php echo $events_details->orientation; ?>');
		
		$("select[name='dress_code']").val("<?php echo $events_details->dress_code; ?>");
		$("select[name='setting']").val("<?php echo $events_details->setting; ?>");
		$("select[name='seating']").val("<?php echo $events_details->seating; ?>");
		
		$("select[name='charity_cut']").val("<?php echo $events_details->charity_cut; ?>");
		$("select[name='charity_id']").val("<?php echo $events_details->charity_id; ?>");
		$("#my_cut").val("<?php echo 100-$events_details->charity_cut; ?>");
		
		var food_drink_type = {!! ($events_details->food_drink_type!="")?$events_details->food_drink_type:"['no data']" !!}; 
