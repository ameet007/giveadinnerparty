    ...
    <div class="container">
      ...
      <div class="row m-t-50">
        <div class="col-sm-12">
          ...
          <form enctype="multipart/form-data" id="demo-form" data-parsley-validate="" novalidate="" method="post" action="{{Request::root()}}/admin/contactus/{{Request::segment(3)}}<?=(ISSET($contactus)) ? '/'.$contact->id : '' ?>">
            <input type="hidden" class="form-control" value="{{csrf_token()}}" name="_token" id="contact">
            <div class="form-group">
              <label for="question">Name * :</label>
              <input type="text" class="form-control" value="<?= (Request::segment(3) == 'edit') ? $contactus->question : old('que') ?>" name="question" id="question" required="">
              @if(ISSET($errors))
